    ...
    <footer className={`mb-0 p-4 ${styles.footer}`}>
      <div className="row">
        ...
        <div className={`col-12 col-sm-6 col-md-4 ${styles.middle}`}>
          ...
          <a
            ...
            href="https://www.linkedin.com/company/vit-bhopal-university/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className={`col-12 col-sm-12 col-md-4 ${styles.right}`}>
          <p className={`${styles.names}`}>
            ...
            <a
              ...
              href="https://www.linkedin.com/in/aditya-singh-b01b33251?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
              rel="noreferrer"
            >
              Aditya Singh
      ...
      <div className={`${styles.footerBottom}`}>
        ...
        <p style={{ textAlign: "center" }}>
          Copyright &copy; 2024 Aditya Singh. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
